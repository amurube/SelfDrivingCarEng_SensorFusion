...
name = 'fpn_resnet' # options are 'darknet', 'fpn_resnet'
configs_det = det.load_configs(model_name = name) 
...
## finalize results_fullpath based on options selected:
if data_filename == 'training_segment-1005081002024129653_5313_150_5333_150_with_camera_labels.tfrecord':
    helper = 'results_sequence_1_'
elif data_filename == 'training_segment-10072231702153043603_5725_000_5745_000_with_camera_labels.tfrecord':
    helper = 'results_sequence_2_'
elif data_filename == 'training_segment-10963653239323173269_1924_000_1944_000_with_camera_labels.tfrecord':
    helper = 'results_sequence_3_'


if name == 'darknet':
    helper =  'darknet/' + helper + 'darknet'
else:
    helper = 'resnet/' + helper + 'resnet/' 

results_fullpath = os.path.join(results_fullpath, helper)
...
while True:
    try:
        ...
        if 'show_range_image' in exec_list:
            img_range = pcl.show_range_image(frame, lidar_name, show_90deg=False)
